                ...
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <div style="border-radius: 10px; margin-bottom: 10px">
                        ...
                        <div class="u-row-container" style="padding: 0px;background-color: transparent">
                            <div class="u-row"
                                style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: rgb(11, 23, 61); border-radius: 10px 10px 0 0;">
                                <div
                                    ...
                                    <div class="u-col u-col-100"
                                        ...
                                        <div style="height: 100%;width: 100% !important;">
                                            ...
                                            <div
                                                ...
                                                <table id="u_content_image_1" style="font-family: Verdana;"
                                                    role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                    border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 20px;font-family: Verdana;"
                                                                align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                                            ...
                                                                            <img align="center" border="0"
                                                                                src="{{ url('storage/default-logo.png') }}"
                                                                                alt="Logo" title="Logo"
                        ...
                        <div class="u-row-container" style="padding: 0px;background-color: transparent">
                            <div class="u-row"
                                style="Margin: 0 auto;min-height: 300px; min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #fbfcff;">
                                            ...
                                            <div
                                                ...
                                                <table style="font-family: Verdana;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding"
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family: Verdana;"
                                                                align="left">

                                                                <div
                                                                    style="color: #908f8f; line-height: 190%; text-align: center; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 190%;">Please kindly ignore this message if you
                                                                    did not initiate this process.</p>
                                                                </div>
                        ...
                        <div class="u-row-container" style="padding: 0px;background-color: transparent">
                            <div class="u-row"
                                style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: rgb(11, 23, 61); border-radius: 0 0 10px 10px;">
                                <div
                                    style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                    <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #f1f2f6;"><![endif]-->
                                    ...
                                    <div style="font-size: 14px; line-height: 190%; color: #ffffff; padding: 10px">
                                        <img align="left" src="{{ url('storage/default-logo.png') }}"
                                            alt="Logo"  width="100" />
